...
namespace ARS
{
    public class MerchantGenerator
    {
        ...
        /// <summary>
        /// Creates the merchants table if it does not exist, then inserts
        /// <paramref name="totalRecords"/> merchants using high-throughput binary COPY.
        /// Progress is written to <see cref="Console"/>.
        /// </summary>
            ...
            int batchSize = 10_000)
        {
            ...
            await using (var cmd = new NpgsqlCommand("""
                CREATE TABLE IF NOT EXISTS public.merchants (
                    ...
                    merchant_address VARCHAR(500) NOT NULL,
                ...
                """, conn))
            {
                ...
                Console.WriteLine("Table public.merchants is ready.");
            }
